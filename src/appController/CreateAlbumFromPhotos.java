...
/**
 * Used to create a new album from photos
 */

public class CreateAlbumFromPhotos {
  ...
  public void createAlbum(ActionEvent event){
    ...
    User.createAlbumFromPhotos(albumTextField.getText(), LoginSceneController.getLoggedInUser(), SearchSceneController.getCorrectPhotos());
